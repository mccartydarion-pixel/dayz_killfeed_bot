...
INSERT INTO guilds (
	...
	death_channel_id, verified_role_id,
...
ON CONFLICT (discord_guild_id) DO UPDATE SET
    ...
    death_channel_id = COALESCE(EXCLUDED.death_channel_id, guilds.death_channel_id),
    verified_role_id = COALESCE(EXCLUDED.verified_role_id, guilds.verified_role_id),
...
RETURNING id`
	...
	err := r.pool.QueryRow(ctx, q,
		...
		emptyToNil(s.DeathChannelID), emptyToNil(s.VerifiedRoleID),
