...
// Everything else either has no publisher yet (CASINO, SHOP, BUILD_FEED, ADMIN_ALERTS,
// HEATMAPS), is a persistent panel/board rather than a single-event card (BOUNTY,
