...
### Axis note (migration `0044_player_location_events_adm_axis_fix`)
...
every heatmap onto a strip along the southern map edge (`z` = a few hundred metres of altitude). Migration `0044` swaps `y`/`z` on all existing
